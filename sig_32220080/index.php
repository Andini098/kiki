...
<head>
    ...
    <script type="text/javascript"
        src="http://maps.google.com/maps/api/js?key=AIzaSyBbeQOhPdvfrFg1SNN6FggLpEMo5PCNK5I"></script>
...
<body onLoad="peta_awal()">
    ...
    <div id="form_lokasi"
        style="background-color:#333333;width:23%; height:600px;text-align:left;padding:10px; float:left;">
        <table>
            <tr>
            ...
            <tr>
                <td></td>
                <td><button id="simpanpeta">Simpan</button><button
                        onclick="javascript:carikordinat(koorAwal);">Koordinat Awal</button></td>
            </tr>
        </table>
